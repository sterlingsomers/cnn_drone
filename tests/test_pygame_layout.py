...
class Widget:
    ...
    def draw_border(self, surface, rect, color, border=True, corners=True, other=False):
        ...
        if other:
            points = ((left + 5, top + 5), (left + 5, top + 30), (left + 50, top + 30), (left + 50 + 10, top + 20),
                      (right - 5, top + 20), (right - 5, top + 5))
            ...
            points = (
            (left + 5, bottom - 5), (left + 5, bottom - 20), (right - 50 - 10, bottom - 20), (right - 50, bottom - 30),
            (right - 5, bottom - 30), (right - 5, bottom - 5))
...
class Button(MovableWidget):
    ...
    def __init__(self, x, y, width, height, movable=False, color=(0, 100, 255), black_margin=5):
        ...
        pygame.draw.rect(self.image, self.color25,
                         (black_margin, black_margin, width - (black_margin * 2), height - (black_margin * 2)), 0)
    ...
    def update(self):
        ...
        if time >= self.alpha_time:
            ...
            for point in self.points:
                ...
                pygame.draw.line(self.points_image, (255, 0, 0, 255), (x + 2 + 15, y + 2 - 15),
                                 (x + 2 + 15 + 30, y + 2 - 15))
...
widgets = [
    ...
    StaticImage(0, 0, '/Users/constantinos/Documents/Projects/cmu_gridworld/cmu_gym/tests/image.jpg'),
]
