...
import os
import sys
#sys.path.append("/Users/constantinos/Documents/Projects/DeepRL-Agents-master")
...
# Build non partial environment (the command in python console creates in science view the plot of the map)
...
class Qnetwork():
    def __init__(self, h_size):
        ...
        self.imageIn = tf.reshape(self.scalarInput, shape=[-1, 84, 84, 3]) / 255.
        ...
        while j < max_epLength:  # If the agent takes longer than 200 moves to reach either of the blocks, end the trial.
            ...
            if total_steps > pre_train_steps:
                ...
                if total_steps % (update_freq) == 0:
                    ...
                    _ = sess.run(mainQN.updateModel,feed_dict={mainQN.scalarInput: np.vstack(trainBatch[:, 0]), mainQN.targetQ: targetQ,
