...
class Display(object):
    def __init__(self, display_size):
        ...
        self.action_size = 4#Environment.get_action_size(flags.env_type, flags.env_name)
    ...
    def get_frame(self): # For recording
...
def main(args):
    ...
    while running:
        ...
        display.update(sess) # THESE NOT THE PYGAME DISPLAY AND UPDATE FUNCTIONS< THESE ARE HIS CUSTOM FUNCTIONS
        # The way his update works is that it fills the background with black and runs the process function which does the stepping and calls all showing functions
        clock.tick(FPS)
